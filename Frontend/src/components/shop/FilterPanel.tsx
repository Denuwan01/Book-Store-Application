...
const FilterPanel = ({ filters, setFilters, showFilters, setShowFilters }: FilterPanelProps) => {
  const filterContent = (
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full"
            />
            <span className="text-sm text-gray-900 dark:text-white">LKR{filters.minPrice}</span>
          </div>
          <div>
            ...
            <input
              ...
              className="w-full"
            />
            <span className="text-sm text-gray-900 dark:text-white">LKR {filters.maxPrice}</span>
          </div>
        </div>
      </div>
